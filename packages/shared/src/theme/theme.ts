import { type PaletteMode, type PaletteOptions, type ThemeOptions, type Components, Typography, Button, IconButton } from '@mui/material';
...
// =============================================================================
// LEGACY STYLED COMPONENTS (backwards compatibility)
// =============================================================================
...
// Styled component for glassmorphic icon buttons (legacy - use MuiIconButton color="primary" instead)
export const GlassIconButton = styled(IconButton)(({ theme }) => ({
  backdropFilter: 'blur(10px)',
  border: `1px solid ${glassEffects.border.dark.accent('teal', 0.3)}`,
  ...
  '&:hover': {
    background: glassEffects.tinted.teal(0.15),
    border: `1px solid ${glassEffects.border.dark.accent('teal', 0.5)}`,
    transform: 'scale(1.05)',
  },
}));

// Re-export for backwards compatibility
export { Typography, Button, IconButton };
