    ...
    <Box sx={{
      ...
      <Fade in={isLoaded} timeout={800}>
        <Box sx={{
          ...
          >
            Understanding binary classification through the sigmoid function. 
            Discover how probabilities emerge from weighted sums and how this 
            mathematical model forms the basis of neural network activation.
          </Typography>
          ...
          <Box sx={{ display: 'flex', gap: 2, mt: 2 }}>
            ...
            <Button
              variant="text"
              onClick={() => navigate('/alchemist-sketches/multi-layer-network')}
              sx={{
                px: 4,
                py: 1.5,
                fontSize: '1rem',
