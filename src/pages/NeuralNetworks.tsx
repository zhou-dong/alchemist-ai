    ...
    <Box sx={{
      ...
      <Fade in={isLoaded} timeout={800}>
        <Box sx={{
          ...
          >
            Master the complete neural network architecture. Understand how all 
            the pieces come together—from individual neurons to complex multi-layer 
            networks—creating systems capable of recognizing patterns, making predictions, 
