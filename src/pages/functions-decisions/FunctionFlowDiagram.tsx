    ...
    return (
        <Fade in={isVisible} timeout={1000}>
            ...
            >
                ...
                >
                    {/* Input Circle */}
                    <Grow in={isVisible} timeout={800} style={{ transitionDelay: '200ms' }}>
                        <Box
                            sx={{
                    ...
                    <Grow in={isVisible} timeout={800} style={{ transitionDelay: '400ms' }}>
                        <Box
                            sx={{
                    ...
                    {/* Output Circle */}
                    <Grow in={isVisible} timeout={800} style={{ transitionDelay: '600ms' }}>
                        <Box
                            sx={{
                                width: { xs: '120px', md: '140px' },
                                height: { xs: '120px', md: '140px' },
