...
export const MultiLayerNetwork = () => {
    ...
    <Box sx={{
      ...
      <Fade in={isLoaded} timeout={800}>
        <Box sx={{
          ...
          >
            Stacking layers to see complex patterns. Learn how multiple layers 
            of neurons work together to recognize intricate relationships in data. 
            Each layer builds upon the previous one, extracting increasingly abstract features.
          </Typography>
          ...
          <Box sx={{ display: 'flex', gap: 2, mt: 2 }}>
            ...
            <Button
              variant="text"
              onClick={() => navigate('/alchemist-sketches/backpropagation')}
              sx={{
                px: 4,
                py: 1.5,
                fontSize: '1rem',
