...
export const Starfield = () => {
  ...
  const starColor = isDarkMode ? '#FFFFFF' : '#4A5568'; // White for dark mode, gray for light mode
  const starGlowColor = isDarkMode ? 'rgba(255, 255, 255, 0.8)' : 'rgba(74, 85, 104, 0.5)'; // Bright glow for dark, subtle for light
