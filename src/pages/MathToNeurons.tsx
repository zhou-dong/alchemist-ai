    ...
    <Box sx={{
      ...
      <Fade in={isLoaded} timeout={800}>
        <Box sx={{
          ...
          >
            Bridge the gap from mathematical functions to neural networks. 
            Learn how abstract mathematical operations translate into the physical 
