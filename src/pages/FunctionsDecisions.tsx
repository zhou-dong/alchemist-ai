    ...
    <Box sx={{
      ...
      <Fade in={isLoaded} timeout={800}>
        <Box sx={{
          ...
          >
            Every decision you make is essentially a function. 
            It takes inputs, applies logic, and produces an output. 
            This fundamental concept bridges human thinking and computational processes.
          </Typography>
