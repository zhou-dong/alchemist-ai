...
export const venusSecondary: RgbaColor = { r: venusBaseColor.r + 21, g: venusBaseColor.g + 13, b: venusBaseColor.b + 26, a: 1 }; // RGB(160, 82, 45)
export const venusAccent: RgbaColor = { r: venusBaseColor.r - 38, g: venusBaseColor.g - 19, b: venusBaseColor.b - 5, a: 1 }; // RGB(101, 50, 14)
export const venusHighlight: RgbaColor = { r: venusBaseColor.r + 41, g: venusBaseColor.g + 31, b: venusBaseColor.b + 31, a: 1 }; // RGB(180, 100, 50)
