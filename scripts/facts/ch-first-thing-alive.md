...
- LUCA itself was very likely sessile too, since flagella/archaella evolved independently after LUCA in each domain, per above. Sessility is not specific to "before LUCA" — it spans before, at, and for some time after LUCA. (plausible)
