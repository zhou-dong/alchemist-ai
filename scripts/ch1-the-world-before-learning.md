...
**Facts.** Biological claims in this chapter are tracked separately in the sibling `almanac` repo, `../../almanac/ch1-the-world-before-learning.md`. Narration should be checked against that file rather than restating or re-deriving facts inline here.
