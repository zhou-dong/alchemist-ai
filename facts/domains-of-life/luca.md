---
topic: LUCA (Last Universal Common Ancestor)
...
*General facts about LUCA, for any chapter to reference. Not chapter-specific.*

- LUCA is not itself a bacterium or an archaeon — it's the population that existed before Bacteria and Archaea diverged from each other. (established, by definition)
...
- LUCA was a single microbial cell, on the order of typical prokaryotic size (roughly 1 micrometer), with no nucleus. (plausible — inferred from traits universally conserved across Bacteria and Archaea)
